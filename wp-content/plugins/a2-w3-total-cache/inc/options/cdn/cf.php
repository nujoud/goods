...
<tr>
    <th colspan="2">
        <span class="description"><?php _e('We recommend that you use <a href="http://docs.amazonwebservices.com/IAM/latest/UserGuide/AccessPolicyLanguage_KeyConcepts.html" target="_blank"><acronym title="AWS Identity and Access Management">IAM</acronym></a> to create a new policy for <acronym title="Amazon Web Services">AWS</acronym> services that have limited permissions. A helpful tool: <a href="http://awspolicygen.s3.amazonaws.com/policygen.html" target="_blank"><acronym title="Amazon Web Services">AWS</acronym> Policy Generator</a>', 'w3-total-cache'); ?></span>
        	<p class="notice notice-info">The Amazon APIs used to create distributions will be deprecated on June 6th, 2019 which may impact the ability to fully use the features available in this panel. If you are unable to create a bucket with a distribution from this panel, you may wish to try to create a distribution directly from your AWS console, or use another CDN option.<br />
        		Additional technical information is available on the AWS Developer discussion forums: <a href="https://forums.aws.amazon.com/ann.jspa?annID=6697" target="_blank">https://forums.aws.amazon.com/ann.jspa?annID=6697</a>
        	</p>
    </th>
</tr>
<tr>
