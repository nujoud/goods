...
?>
<div class="<?php echo $gallery_item_class; ?> yith_featured_content" data-thumb="<?php echo $thumbnail_url; ?>">
    <div class="ywcfav-video-content <?php echo $video_class . ' ' . $aspect_ratio; ?>">
        <iframe id="video_<?php echo $product->get_id(); ?>" src="<?php echo $url; ?>" type="text/html" frameborder="0" allowfullscreen>
        </iframe>
    </div>
</div>